...
<body class="manager">
   <div id="tb" style="padding: 5px 1px 5px">
	...
	<table id="dg" class="easyui-treegrid" style="width: 100%; height: 100%" data-options="idField:'id',treeField:'base_name',url:'/getPageBase.do?ffmodel=role',method:'get',autoRowHeight:false,pageSize:20,fitColumns:true,striped:true,rownumbers:true,singleSelect:true,toolbar:'#tb'">
		<thead>
			<tr>
	...
	<div id="dlg" title="信息" class="easyui-dialog" style="width: 300px; height: 350px" closed="true" buttons="#dlg-buttons" data-options="modal:true">
		<form id="ff" method="post">
			<table style="width:100%">
				...
				<tr>
					<td align=right class="cx_Title">角色编号：</td>
				...
				<tr>
					...
					<td><input class="easyui-numberbox easyui-validatebox" name="BASE_ORDER" data-default="0" data-options="required:true,min:0,max:999"></TD>
				</tr>
				<tr>
			...
			<input type="hidden" name="PARENT_ID" data-default="0"/>	
		</form>
